...
class ResNetAID:
    def __init__(self, device=None):
        ...
        self.device = device
        try:
            trained = torch.load('./checkpoints/Res34_AID_best.pth',map_location=torch.device('cpu'))
        except:
            trained = torch.load('.D:/fifthYear/5th_year_project/Remote-Sensing-ChatGPT-main/checkpoints/Res34_AID_best.pth',map_location=torch.device('cpu'))
